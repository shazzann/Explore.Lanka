        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <Button asChild variant="default" className="bg-lanka-blue hover:bg-lanka-blue/90">
                <Link to="/game">Start Exploring</Link>
              </Button>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              <div className="mb-4 p-2 bg-lanka-green/10 rounded-full w-fit">
                <Compass className="h-6 w-6 text-lanka-green" />
              </div>
              ...
              <Button asChild variant="outline" className="border-lanka-green text-lanka-green hover:bg-lanka-green/10">
      ...
      <section className="py-12 bg-white">
        <div className="container px-4 md:px-6">
          <div className="flex justify-between items-center mb-6">
            ...
            {!user && (
              <div className="flex items-center text-amber-600 font-medium text-sm px-3 py-2 bg-amber-50 rounded-md">
          ...
          {loading ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-[360px] bg-gray-100 animate-pulse rounded-lg"></div>
              ))}
            </div>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
              <div className="mx-auto mb-4 p-2 bg-lanka-blue/10 rounded-full w-fit">
                <MapPin className="h-6 w-6 text-lanka-blue" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
              <div className="mx-auto mb-4 p-2 bg-lanka-orange/10 rounded-full w-fit">
                <Trophy className="h-6 w-6 text-lanka-orange" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
              <div className="mx-auto mb-4 p-2 bg-lanka-green/10 rounded-full w-fit">
                <Camera className="h-6 w-6 text-lanka-green" />
              </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center gap-1">
              <span className="font-bold text-lanka-blue">Explore</span>
              <span className="font-bold text-lanka-green">Lanka</span>
            </div>
