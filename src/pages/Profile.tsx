...
import { Trophy, MapPin, Camera, User, Lock, Loader2 } from 'lucide-react';
...
const Profile = () => {
  ...
  const { unlockedLocations, locationsLoading, userPhotos, photosLoading, updateProfile } = useProfile();
            ...
            <Card>
              <CardHeader className="text-center">
                <Avatar className="h-24 w-24 mx-auto mb-4">
                  ...
                  <AvatarFallback className="text-2xl bg-lanka-blue/10 text-lanka-blue">{getInitials()}</AvatarFallback>
                </Avatar>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4 mt-2">
                  <div className="text-center py-3 bg-secondary/50 rounded-md">
                    <p className="text-2xl font-semibold text-lanka-blue">{profile.points || 0}</p>
                    <p className="text-sm text-muted-foreground">Points</p>
                  </div>
                  <div className="text-center py-3 bg-secondary/50 rounded-md">
                    <p className="text-2xl font-semibold text-lanka-green">{profile.places_unlocked || 0}</p>
